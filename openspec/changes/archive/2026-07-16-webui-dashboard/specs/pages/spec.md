...
- `/` — Dashboard / Home
- `/new` — New Benchmark Run
- `/runs/:id` — Run Detail
- `/runs/:id/prs/:pr_key` — PR Detail (agent logs)
- `/runs/:id/live` — Live View
- `/adhoc` — Ad-hoc Review Runs
- `/adhoc/new` — New Ad-hoc Review
- `/adhoc/runs/:id` — Ad-hoc Run Detail (reuses RunDetailPage)

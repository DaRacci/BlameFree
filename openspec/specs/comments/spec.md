...
## Purpose
Review finding comment structure and schema defining the structured output format for agent-generated review findings.
## Requirements
...
The system SHALL return empty arrays and zero-value metrics for reviews with no findings or processing errors.

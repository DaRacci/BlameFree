...
//! `riv_types::cost` so they can be shared with the webui crate.
...
pub use riv_types::cost::{AnalyticsSnapshot, CacheUsage, SessionUsage};
...
impl AnalyticsTracker {
    ...
    /// Build a [`riv_types::cost::AnalyticsSnapshot`] of the current state.

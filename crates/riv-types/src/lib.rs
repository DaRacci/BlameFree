...
/// Allow `::riv_types::*` absolute paths to resolve to the current crate,
/// matching what the `riv_macros::FlattenedStruct` derive macro generates.
#[cfg(feature = "seaorm-storage")]
extern crate self as riv_types;

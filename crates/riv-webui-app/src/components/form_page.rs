...
/// A full-page form layout shell with header, config loading/error state, submit button, and submit error display.
/// Wraps arbitrary form field children.
#[component]
pub fn FormPage(

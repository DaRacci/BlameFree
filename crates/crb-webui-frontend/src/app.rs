                ...
                <main class="main-content">
                    <div class="content-container">
                        <Routes>
                            ...
                            <Route path="/runs/:id" view=|| view! { <RunDetailPage /> } />
                            <Route path="/runs/:id/prs/:pr_key" view=|| view! { <PrDetailPage /> } />
                            <Route path="/runs/:id/live" view=|| view! { <LivePage /> } />
                            <Route path="/new" view=|| view! { <NewRunPage /> } />
                            <Route path="/adhoc" view=|| view! { <AdhocRunsPage /> } />
                            <Route path="/adhoc/new" view=|| view! { <AdhocReviewPage /> } />
                            <Route path="/adhoc/runs/:id" view=|| view! { <RunDetailPage /> } />
                            <Route path="/admin" view=|| view! { <AdminPage /> } />
